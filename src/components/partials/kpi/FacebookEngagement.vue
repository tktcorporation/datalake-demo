<template>
    <div>
        <div class="facebook-engagement card" 
            :class="{
            ...
            <!--
            <div class="card-header" :class="{'text-white bg-success':avrgInteractionsPerPost > threshold, 'text-white bg-danger':avrgInteractionsPerPost < threshold}">Facebook Reach</div>
            -->
            <div class="card-body">
                
                <h5 class="card-title">
                    <i class="fab fa-facebook"></i> Engagement
                </h5>
...
export default {
    ...
    methods: {
        ...
        async init(){
            ...
            var proj = 'interactions, page_posts, date, profile_id'
            ...
            this.$log(`facebook ${this.profiles[0].profile_id}`, data)
            ...
            this.totalPosts =  _.sumBy(data.results, function(o){return parseInt(o.page_posts)}) 
