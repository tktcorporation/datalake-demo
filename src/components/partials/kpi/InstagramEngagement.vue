<template>
    <div>
        <div class="instagram-engagement card" 
            :class="{
            ...
            <div class="card-body">
                ...
                <h5 class="card-title">
                    <i class="fab fa-instagram"></i> Engagement
                </h5>
...
export default {
    ...
    methods: {
        ...
        async init(){
            ...
            var proj = 'interactions, profile_posts, date, profile_id'
            ...
            this.totalPosts =  _.sumBy(data.results, function(o){return parseInt(o.profile_posts)}) 
