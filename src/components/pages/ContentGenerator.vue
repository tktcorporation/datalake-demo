<template>
    <div class="container" align="left">
      ...
      <div class="jumbotron mt-4">
        ...
        <p class="lead">Enter a short, sample sentence as a seed to generate the fake content using the <a target="_blank" href="https://blog.openai.com/better-language-models/">GPT-2 algorithm from OpenAI</a></p>
        ...
        <div v-if="generatedText" class="pt-0 mt-0 text-generated" v-html="generatedText">
        </div>
...
export default {
    ...
    methods: {
        onSubmit(){
            ...
            var path = 'http://127.0.0.1:5000/content/generate'
